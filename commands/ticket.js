exports.run = async (client, message, args) => {
    ...
    try { // ← Tentar criar o canal, se nao conseguir cai no catch
        channel = await message.guild.channels
            .create(`${message.member.displayName}•${message.author.discriminator}┋${message.author.id}`,
        ...
        setTimeout(() => channel.delete() // tenta deletar o canal
            ...
            .catch(err => message.channel.send('Erro: ' + err.message)), 1440 * 86400) // 1000 * 60 == 1 minuto em milissegundos (ms)
}
